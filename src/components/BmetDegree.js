...
function BmetDegree(props) {
          ...
          <Col md={7}>
            <Fade left>
              ...
              <p className="lead">
                ...
                Students undergo training in electronics and computer
                technology, with an emphasis on medical applications,
                operations, and procedures. The program includes instruction in
                instrument calibration, design, installation and testing, as
                well as safety, maintenance, and equipment repair procedures.
                The general education component of the program prepares students
  ...
  degree"
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  experience that the trust formed in the classroom translates
                  to student success. I am looking forward to working with and
  ...
  degree"
        ...
        <Row>
          ...
          <p>
            Students will garner the theoretical and practical knowledge
            necessary to work in the biomedical technology and healthcare
            technology management fields. The student will develop leadership
            skills and an understanding of policies that govern diagnosis
            centers, healthcare facilities, and modern hospitals. Students learn
            how to repair, calibrate, measure, and diagnose failures in medical
            equipment and biomedical instruments.
          </p>
          <h4>PERFORMANCE OBJECTIVES</h4>
          <p>
            Students will learn how to apply basic engineering principles and
            technical skills to solve complex biomedical problems including how
            to properly maintain diagnostic and life support equipment in the
            health and medical fields; utilizing electronic and computer
            technology for medical equipment calibration, application, and
            testing; evaluating equipment policies and procedures; conducting
            safety and maintenance checks, and consulting and managing
            healthcare technology divisions within hospitals and healthcare
            organizations.
          </p>
