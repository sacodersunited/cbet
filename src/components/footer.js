...
import ferpaPolicy from "../documents/CBET Notification of Rights Under FERPA for Post-Seconday Education.pdf"
        ...
        <Container>
          <Row>
            ...
            <Col md={2} className="mb-4 mb-md-0">
              ...
              <a href={ferpaPolicy} className="d-block text-light mb-3">
                FERPA Notice
              </a>
            </Col>
            <Col md={2} className="mb-4 mb-md-0">
            ...
            <Col md={2} className="mb-4 mb-md-0">
              ...
              <a
                ...
                href="mailto:webmaster@cbet.edu"
              >
                webmaster@cbet.edu
              </a>
            </Col>
