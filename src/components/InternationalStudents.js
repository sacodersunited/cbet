    ...
    <Container className="mb-5">
      <Row className="mb-3">
        <Col md={7}>
          ...
          <Img fluid={props.images.intl1.childImageSharp.fluid} />
          ...
          <Img fluid={props.images.intl2.childImageSharp.fluid} />
          <p>
          ...
          <Img fluid={props.images.intl3.childImageSharp.fluid} />
          <p>
          ...
          <Img fluid={props.images.intl4.childImageSharp.fluid} />
        </Col>
      </Row>
    </Container>
  </>
