          ...
          <Col sm={3}>
            <ListGroup style={{ overflowY: "scroll", height: "45vh" }}>
              ...
              <ListGroup.Item action href="#link2">
                How long does it take to complete the BMET Certificate training?
              </ListGroup.Item>
          ...
          <Col sm={6}>
            <Tab.Content>
              ...
              <Tab.Pane eventKey="#link2">
                <p>
                  The certificate training can be completed in approximately 25
                  weeks.
                </p>
              </Tab.Pane>
              ...
              <Tab.Pane eventKey="#link5">
                <p>
                  ...
                  professional job placement support, and other forms assistance
                  designed to ensure you earn the opportunity to pursue the
                  career you seek.
                </p>
              </Tab.Pane>
            </Tab.Content>
